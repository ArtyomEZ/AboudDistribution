...
<header class="main-header">
    <nav class="header-navigation">
        ...
        <?php if (!empty($_SESSION['login'])): ?>
            <!-- Affichage du nom de l'utilisateur avec un lien vers la page Param -->
            <div class="dropdown">
                <a href="pageParam.php"><span class="user-name">👤 <?= htmlspecialchars($_SESSION['login']) ?></span></a>
                <div class="dropdown-content">
                    <a href="../Controller/LogoutController.php" class="logout-btn">Se Déconnecter</a>
                </div>
            </div>

            <!-- Affichage du lien vers le panier si l'utilisateur est connecté -->
            <a href="panier.php" class="cart-btn">
                <!-- Vous pouvez utiliser un émoji ou une image pour le panier -->
                🛒 Panier
            </a>
        <?php else: ?>
    ...
    <nav class="dropdown-menu">
        ...
        <div class="dropdown">
            <button class="dropdown-btn">Lubrifiant</button>
                <div class="dropdown-content">
                    <a href="pageCategorie.php?categorie=huile-moteur">Huile Moteur</a>
                    <a href="pageCategorie.php?categorie=huile-transmission">Huile de Transmission</a>
                    <a href="pageCategorie.php?categorie=huile-hydraulique">Huile Hydraulique</a>
                    <a href="pageCategorie.php?categorie=graisse">Graisse</a>
                </div>
            </div>
    </nav>
</header>
